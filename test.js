function randName() {
    ...
    */
    ...
    let fIndex = Math.floor(Math.random() * firstname.length)
    let first = firstname[fIndex]

    let mIndex = Math.floor(Math.random() * lastname.length)
    let middle = lastname[mIndex]

    let lIndex = Math.floor(Math.random() * lastname.length)
    let last = lastname[lIndex]
